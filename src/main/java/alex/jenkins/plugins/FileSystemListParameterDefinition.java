...
import static alex.jenkins.plugins.FileSystemListParameterDefinition.FsObjectTypes.DIRECTORY;
import static alex.jenkins.plugins.FileSystemListParameterDefinition.FsObjectTypes.FILE;
import static alex.jenkins.plugins.FileSystemListParameterDefinition.FsObjectTypes.SYMLINK;
...
public class FileSystemListParameterDefinition extends ParameterDefinition {
    ...
    public static class DescriptorImpl extends ParameterDescriptor {
        ...
        public FormValidation doCheckSlaveAgentName(@QueryParameter final String slaveAgentName) throws IOException {
            this.slaveAgentName=slaveAgentName;
            if (!isSlaveAgentExists(slaveAgentName)) {
                return FormValidation.error(Messages.FileSystemListParameterDefinition_SlaveAgentNotExists(),slaveAgentName);
            }
            return FormValidation.ok();
        }
        ...
        public FormValidation doCheckPath(@QueryParameter final String path) throws IOException {
            ...
            try {
                if (!isPathExists(this.slaveAgentName, path)) {
                    return FormValidation.error(Messages.FileSystemListParameterDefinition_PathDoesntExist(), path);
                }
            } catch (Exception ex) {
                return FormValidation.error(Messages.FileSystemListParameterDefinition_UnknownException());
            }
            return FormValidation.ok();
        }
    ...
    public FileSystemListParameterDefinition(String name, String description, String path, String selectedType, String regexIncludePattern, String regexExcludePattern, boolean sortByLastModified, boolean sortReverseOrder,String slaveAgentName) {
    ...
    public ParameterValue getDefaultParameterValue() {
        ...
        try {
            ...
            LOGGER.warning(String.format(Messages.FileSystemListParameterDefinition_SymlinkDetectionError(), defaultValue));
        }
    ...
    public static boolean isSlaveAgentExists(String slaveAgentName){
        Computer computer = null;
        VirtualChannel channel = null;
        Jenkins instance = Jenkins.getInstance();
        if (slaveAgentName != null && instance != null) {
    ...
    public static boolean isPathExists(String slaveAgentName,String path) throws Exception {
        Computer computer = null;
        VirtualChannel channel = null;
        Jenkins instance = Jenkins.getInstance();
        if (slaveAgentName != null && instance != null) {
